/******************************************************************************
    ...
    Description:  A test program for hash tables. 
                  It reads one word at a time from the console until the input 
                  ends by an eof - a CTRL-D under a Linux terminal, or the end 
                  of the file in case of redirection, or Ctrl-C under Windows. 
                  Words that are part of the list of stop words are discarded. 
                  For all the others, it applied the Porter transformation to
                  extract the root, then updates the count of this root in the
                  indexing table. 
                  After the input ends, the indexing table and some statistics
                  are output.
*******************************************************************************/
