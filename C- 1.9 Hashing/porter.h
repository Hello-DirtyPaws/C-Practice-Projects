...
// different versions of the functions based on platform
//#define mysprintf sprintf_s  // windows
//#define mystrcpy strcpy_s    //
//#define mystrncat strncat_s  //

#define mysprintf snprintf                  // linux
#define mystrcpy(a,b,c) strcpy(a,c)         //
#define mystrncat(a,b,c,d) strncat(a,c,d)   //
